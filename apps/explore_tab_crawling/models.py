...
class Content(models.Model):
    ...
    hashtags = models.CharField(max_length=2000, null=False, verbose_name="해시태그")
...
class Hashtag(models.Model):
    ...
    content_id = models.ForeignKey(Content, null = False, on_delete=models.CASCADE,verbose_name="콘텐츠")
    ...
    class Meta:
        db_table = 'hashtag'
        constraints = [
            UniqueConstraint(fields=['content_id', 'text'], name='unique_content_text')
        ]
